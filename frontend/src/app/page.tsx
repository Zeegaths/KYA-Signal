    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .kp-sub { font-size: 9px; color: #222; font-family: 'JetBrains Mono', monospace; margin-left: 10px; }
        .kp-navlinks { display: flex; align-items: center; gap: 32px; }
        .kp-navlinks a { font-size: 12px; color: #444; text-decoration: none; transition: color .15s; letter-spacing: 0.03em; }
        .kp-navlinks a:hover { color: #fff; }
        .kp-navcta {
          background: #F7931A; color: #000; font-weight: 700; font-size: 12px;
          border: none; border-radius: 7px; padding: 9px 20px; cursor: pointer;
        ...
        .kp-hero-glow {
          ...
          background: radial-gradient(ellipse 80% 60% at 50% 50%, rgba(247,147,26,0.12) 0%, transparent 70%);
        }
        .kp-hero-inner { position: relative; z-index: 1; max-width: 900px; margin: 0 auto; }

        .kp-eyebrow {
          font-size: 9px; font-family: 'JetBrains Mono', monospace;
          color: #F7931A; letter-spacing: 0.2em;
          margin-bottom: 28px;
          display: flex; align-items: center; justify-content: center; gap: 16px;
        }
        .kp-eyebrow::before, .kp-eyebrow::after {
          content: ''; flex: 1; max-width: 60px; height: 1px; background: rgba(247,147,26,0.3);
        }

        .kp-h1 {
          font-size: 88px; font-weight: 700; line-height: 0.88;
          letter-spacing: -5px; margin-bottom: 32px; color: #fff;
          text-transform: uppercase;
        }
        .kp-h1 .o { color: #F7931A; }

        .kp-hero-desc {
          font-size: 17px; color: #888; line-height: 1.8;
        ...
        .kp-btn-p {
          background: #F7931A; color: #000; font-weight: 700; font-size: 14px;
        ...
        .kp-btn-s {
          ...
          border: 1px solid #2a2a2a; border-radius: 8px; padding: 14px 32px; cursor: pointer;
          font-family: 'Space Grotesk', sans-serif; transition: border-color .15s;
        }
        .kp-btn-s:hover { border-color: #555; }

        /* LTV tier cards — hero bottom */
        .kp-ltv-row {
        ...
        .kp-ltvc:hover { border-color: #333; }
        ...
        .kp-ltvc-req { font-size: 9px; font-family: 'JetBrains Mono', monospace; color: #333; }
        ...
        .kp-stat-l { font-size: 11px; font-family: 'JetBrains Mono', monospace; color: #333; letter-spacing: 0.05em; }
        ...
        .kp-slabel {
          font-size: 9px; font-family: 'JetBrains Mono', monospace;
          color: #F7931A; letter-spacing: 0.18em; margin-bottom: 16px;
        ...
        .kp-sh {
          ...
          border-left: 3px solid #F7931A; padding-left: 18px;
          text-transform: uppercase;
        }
        .kp-sh.g { border-left-color: #cafd00; }

        .kp-body-text { font-size: 14px; color: #666; line-height: 1.85; margin-bottom: 28px; }
        ...
        .kp-jsub { font-size: 10px; font-family: 'JetBrains Mono', monospace; color: #3a3a3a; }
        ...
        .kp-jslbl.u { color: #2a2a2a; }
        .kp-jarrow { display: flex; align-items: center; gap: 10px; padding: 0 16px; }
        .kp-jline { flex: 1; height: 1px; background: #1a1a1a; }
        .kp-jtxt { font-size: 9px; font-family: 'JetBrains Mono', monospace; color: #222; white-space: nowrap; }
        ...
        .kp-psn.w { color: #fff; }
        .kp-psl { font-size: 10px; font-family: 'JetBrains Mono', monospace; color: #333; }
        ...
        .kp-sltvreq { font-size: 10px; font-family: 'JetBrains Mono', monospace; color: #333; }
        ...
        .kp-coderesp {
          ...
          padding: 18px; font-family: 'JetBrains Mono', monospace; font-size: 11px; line-height: 2;
        }
        ...
        .kp-pipe-h {
          ...
          color: #F7931A; letter-spacing: 0.2em; margin-bottom: 20px;
          display: flex; align-items: center; justify-content: center; gap: 12px;
        }
        .kp-pipe-h::before, .kp-pipe-h::after {
          content: ''; flex: 1; max-width: 80px; height: 1px; background: rgba(247,147,26,.25);
        }
        .kp-pipe-title {
        ...
        .kp-step:not(:last-child)::after {
          ...
          left: 39px; top: 52px; bottom: 0; width: 1px; background: #1a1a1a;
        }
        .kp-step-num {
        ...
        .kp-step-circle {
          ...
          background: #0d0d0d; border: 1px solid #1e1e1e; color: #333;
        ...
        .kp-step-desc { font-size: 13px; color: #555; line-height: 1.7; font-family: 'JetBrains Mono', monospace; }
        .kp-step-desc strong { color: #888; font-weight: 500; }
        ...
        .kp-mc-icon {
          ...
          background: rgba(247,147,26,.08); border: 1px solid rgba(247,147,26,.15);
          display: flex; align-items: center; justify-content: center; flex-shrink: 0;
        }
        .kp-mc h3 { font-size: 15px; font-weight: 600; color: #fff; }
        .kp-mc p { font-size: 13px; color: #555; line-height: 1.75; margin-bottom: 14px; }
        .kp-mc-tag {
          font-size: 9px; font-family: 'JetBrains Mono', monospace;
          color: #2a2a2a; background: #111; padding: 3px 9px;
          border-radius: 3px; border: 1px solid #1a1a1a;
        }

        /* ── QUERY ── */
        .kp-qsec {
          padding: 80px 48px; border-bottom: 1px solid #1a1a1a;
        ...
        .kp-qp { font-size: 14px; color: #666; line-height: 1.8; margin-bottom: 28px; }
        ...
        .kp-rl { font-size: 9px; font-family: 'JetBrains Mono', monospace; color: #333; }
        ...
        .kp-qbarlabel { font-size: 10px; font-family: 'JetBrains Mono', monospace; color: #2a2a2a; margin-left: 8px; }
        ...
        .kp-fl a { font-size: 11px; color: #222; text-decoration: none; margin-right: 20px; transition: color .15s; }
        .kp-fl a:hover { color: #fff; }
        .kp-fanc { display: flex; align-items: center; gap: 6px; font-size: 10px; font-family: 'JetBrains Mono', monospace; color: #222; }
      ...
      <div className="kp">
        ...
        <div className="kp-hero">
          ...
          <svg className="kp-hero-bg" viewBox="0 0 1400 700" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="g1" width="48" height="48" patternUnits="userSpaceOnUse">
                <path d="M 48 0 L 0 0 0 48" fill="none" stroke="#1c1c1c" strokeWidth="0.6"/>
              </pattern>
            </defs>
          ...
          <div className="kp-hero-inner">
            ...
            <h1 className="kp-h1">
              KNOW YOUR<br/><span className="o">AGENT.</span>
            </h1>

            <p className="kp-hero-desc">
              Portable reputation for autonomous agents. <strong>Real-time trust
              metrics anchored to Bitcoin&apos;s immutable ledger.</strong>
            </p>
        ...
        <div className="kp-stats">
          <div className="kp-stat">
            <div className="kp-stat-n"><span id="cnt1" className="o">0+</span></div>
            <div className="kp-stat-l">AGENTS ON SOLANA</div>
          </div>
          <div className="kp-stat">
            <div className="kp-stat-n"><span id="cnt2" className="g">0B</span></div>
            <div className="kp-stat-l">ETH TVL REACHABLE</div>
          </div>
          <div className="kp-stat">
            <div className="kp-stat-n"><span id="cnt3">0</span></div>
            <div className="kp-stat-l">EVENTS INDEXED LIVE</div>
          </div>
        </div>
        ...
        <div className="kp-probgrid">
          <div className="kp-pcol">
            ...
            <div className="kp-sh" style={{ marginBottom:'20px' }}>
              AGENT REPUTATION<br/>DOESN&apos;T TRAVEL.
            </div>
            <p className="kp-body-text">
              On-chain performance data creates friction for cross-chain agents. Without
              a unified score, capital efficiency is capped at the network level.
            </p>
            <div className="kp-journey">
              <div className="kp-jcard">
                <div className="kp-jav sol">S</div>
                <div>
                  <div className="kp-jname">Agent #4021</div>
                  <div className="kp-jsub">Solana · 847 txs · 99.1% success</div>
                </div>
                <div className="kp-jscore">
                  <div className="kp-jsval k">94</div>
                  <div className="kp-jslbl k">known ✓</div>
                </div>
              </div>
              <div className="kp-jarrow">
                <div className="kp-jline"/>
                <div className="kp-jtxt">moves to Ethereum</div>
                <div className="kp-jline"/>
              </div>
              <div className="kp-jcard" style={{ opacity:.55 }}>
                ...
                <div>
                  <div className="kp-jname">Agent #4021</div>
                  <div className="kp-jsub">Ethereum · 0 txs · no history</div>
                </div>
                <div className="kp-jscore">
                  <div className="kp-jsval u">?</div>
                  <div className="kp-jslbl u">stranger</div>
                </div>
              </div>
            </div>
            <div className="kp-pstats">
              {[
                { n:'60%',  c:'o', l:'LTV without KYA' },
                { n:'90%',  c:'g', l:'LTV with KYA Premium' },
                { n:'9K+',  c:'w', l:'agents hitting this daily' },
                { n:'$53B', c:'w', l:'TVL locked behind it' },
              ].map((s,i) => (
                <div key={i} className="kp-ps">
                  <div className={`kp-psn ${s.c}`}>{s.n}</div>
                  <div className="kp-psl">{s.l}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="kp-pcol dark">
            ...
            <div className="kp-sh g" style={{ marginBottom:'20px' }}>
              A PORTABLE,<br/>BITCOIN-ANCHORED SCORE.
            </div>
            <p className="kp-body-text">
              By settling reputation proofs on Bitcoin, KYA Signal provides an immutable,
              permissionless identity layer that any protocol can query permissionlessly.
            </p>
            <div className="kp-sol-ltvcards">
              {[
                { pct:'60%', col:'#444',    name:'Base LTV',    req:'score < 85 · default', bw:'60%', bc:'#2a2a2a', cls:'' },
                { pct:'80%', col:'#cafd00', name:'KYA Verified', req:'score ≥ 85',           bw:'80%', bc:'#cafd00', cls:'a' },
                { pct:'90%', col:'#F7931A', name:'KYA Premium',  req:'score ≥ 95',           bw:'90%', bc:'#F7931A', cls:'p' },
              ].map((t,i) => (
                <div key={i} className={`kp-sltvc ${t.cls}`}>
                  <div className="kp-sltvcn" style={{ color: t.col }}>{t.pct}</div>
                  <div>
                    <div className="kp-sltvname">{t.name}</div>
                    <div className="kp-sltvreq" style={{ color: t.col + '88' }}>{t.req}</div>
                  </div>
                  <div className="kp-sltvbar" style={{ marginLeft:'auto' }}>
                    <div className="kp-sltvbf" style={{ width: t.bw, background: t.bc }}/>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="kp-steps">
            {[
              ...
              <div key={i} className="kp-step">
                <div className="kp-step-num">
                  <div className={`kp-step-circle ${s.cls}`}>{s.n}</div>
                </div>
        ...
        <div className="kp-market">
          <div className="kp-market-head">
            ...
            <div className="kp-sh" style={{ fontSize:'40px', borderLeft:'none', paddingLeft:0 }}>
              ASYMMETRIC TRUST<br/>IN AGENTIC ECONOMIES.
            </div>
          </div>
            ...
            {[
              ...
              <div key={i} className="kp-mc">
                <div className="kp-mc-top">
                  <div className="kp-mc-icon">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                      <path d="M8 2L14 5v4c0 3-2.5 4.5-6 5-3.5-.5-6-2-6-5V5l6-3z" stroke="#F7931A" strokeWidth="1.2"/>
                    </svg>
                  </div>
                  <h3>{m.t}</h3>
                </div>
        ...
        <div className="kp-qsec">
          ...
          <div className="kp-qcode">
            <div className="kp-qbar">
              <div className="kp-qbd" style={{background:'#F7931A'}}/>
              <div className="kp-qbd" style={{background:'#cafd00'}}/>
              <div className="kp-qbd" style={{background:'#222'}}/>
        ...
        <footer className="kp-footer">
          ...
          <div className="kp-fanc">
            <span className="kp-fdot"/>
            Bitcoin anchored · Mezo Hackathon 2025
          </div>
        </footer>

...
export default function RegisterPage() {
  ...
  const handleWalletConnect = (address: string, chain: 'ethereum' | 'solana') => {
    setForm(f => ({ ...f, sourceChainKey: address, sourceChain: chain }));
  };
  ...
  return (
    <>
      <style>{`
        ...
        .rp-wrap { display: flex; justify-content: center; align-items: flex-start; min-height: calc(100vh - 64px); padding: 48px 24px; }
        .rp { width: 100%; max-width: 520px; font-family: 'Space Grotesk', sans-serif; }
        ...
        .rp-label { display: block; font-size: 10px; font-family: 'JetBrains Mono', monospace; color: #aaa; letter-spacing: 0.12em; margin-bottom: 10px; font-weight: 500; }
        .rp-input { width: 100%; background: #111; border: 1px solid #222; border-radius: 8px; padding: 14px 16px; font-family: 'JetBrains Mono', monospace; font-size: 13px; color: #fff; outline: none; transition: border-color 0.15s, background 0.15s; display: block; }
        ...
        .rp-chain { padding: 12px 0; border-radius: 8px; border: 1px solid #1f1f1f; background: #0f0f0f; color: #666; font-size: 13px; font-weight: 600; cursor: pointer; transition: all 0.15s; text-align: center; font-family: 'Space Grotesk', sans-serif; }
        ...
        .rp-preview { background: #0f0f0f; border: 1px solid #1f1f1f; border-radius: 10px; overflow: hidden; margin-bottom: 24px; }
        ...
        .rp-btn-primary { flex: 1; padding: 14px; background: #F7931A; color: #000; font-weight: 700; font-size: 13px; border: none; border-radius: 8px; cursor: pointer; font-family: 'Space Grotesk', sans-serif; transition: opacity 0.15s; letter-spacing: 0.02em; }
        .rp-btn-primary:hover { opacity: 0.88; }
        .rp-btn-primary:disabled { opacity: 0.3; cursor: not-allowed; }
        .rp-btn-secondary { flex: 1; padding: 14px; background: transparent; color: #888; font-weight: 500; font-size: 13px; border: 1px solid #1f1f1f; border-radius: 8px; cursor: pointer; font-family: 'Space Grotesk', sans-serif; transition: all 0.15s; }
        .rp-btn-secondary:hover { border-color: #333; color: #fff; }
        .rp-error { background: rgba(239,68,68,0.07); border: 1px solid rgba(239,68,68,0.2); border-radius: 8px; padding: 12px 16px; font-size: 12px; color: #f87171; margin-bottom: 16px; font-family: 'JetBrains Mono', monospace; line-height: 1.6; }
        .rp-success { display: flex; flex-direction: column; gap: 24px; }
        .rp-success-top { display: flex; align-items: center; gap: 16px; }
        .rp-check { width: 42px; height: 42px; border-radius: 50%; background: rgba(202,253,0,0.08); border: 1px solid rgba(202,253,0,0.2); display: flex; align-items: center; justify-content: center; font-size: 16px; color: #cafd00; flex-shrink: 0; }
        .rp-success-title { font-size: 22px; font-weight: 700; color: #fff; margin-bottom: 4px; }
        .rp-success-sub { font-size: 13px; color: #666; }
        .rp-geid-card { background: #0f0f0f; border: 1px solid rgba(202,253,0,0.15); border-radius: 10px; padding: 20px 22px; }
        ...
        .rp-btc-row { display: flex; justify-content: space-between; align-items: center; margin-top: 16px; padding-top: 16px; border-top: 1px solid #1a1a1a; }
        ...
        .rp-note { font-size: 12px; color: #444; line-height: 1.75; font-family: 'JetBrains Mono', monospace; background: #0d0d0d; border: 1px solid #1a1a1a; border-radius: 8px; padding: 14px 16px; }
        .rp-note code { color: #666; }
        .rp-wallet-divider { display: flex; align-items: center; gap: 12px; margin-bottom: 24px; }
        .rp-wallet-divider-line { flex: 1; height: 1px; background: #1a1a1a; }
        .rp-wallet-divider-text { font-size: 9px; font-family: 'JetBrains Mono', monospace; color: #333; letter-spacing: 0.1em; }
      `}</style>
        ...
        <div className="rp">
          ...
          {step === 'form' && (
            <div>
              ...
              <div className="rp-wallet-divider">
                <div className="rp-wallet-divider-line" />
                <div className="rp-wallet-divider-text">OR ENTER MANUALLY</div>
                <div className="rp-wallet-divider-line" />
              </div>
